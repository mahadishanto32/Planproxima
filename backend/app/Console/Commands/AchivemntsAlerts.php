...
class AchivemntsAlerts extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'achivements:alert';
        ...
        foreach($monthly_report as $departments){           
            if(isset($departments['hod_email'])){ 
               ...
               // $phpMail->AddAddress('asif.imran@ssgbd.com',  $departments['hod_name']);
                ...
                $phpMail->AddCC('sayed@gmail.com', "System CC");
                $nextmonth = "";
                // '.date('F').'.'.
                $data['nextmonth'] = $end_date;
                $data['all_dept_comm'] = "Today is the last date of submitting (Monthly Achivemnts) for the month of ".date('M').".Please submit on due time and cooperate";
