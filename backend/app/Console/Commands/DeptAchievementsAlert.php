...
class DeptAchievementsAlert extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'report:dept_achievements_alert';
    ...
    public function handle()
    {
        ...
        foreach ($Department as $value) {
            ...
            if (isset($value->hod_email)) {
              ...
              // July Monthly KPI Achievement and Summary Report Panel will close today, thank you for your cooperation.

                $data['contena'] = '<p>'. $previous_date . ' Monthly KPI Achievement and Summary Report Panel will close today, Thank you for your cooperation.
                </br> 
                Regards,
                Team BPT 
                    ';
