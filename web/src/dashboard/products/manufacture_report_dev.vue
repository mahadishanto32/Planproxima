                            ...
                            <div class="row border rounded py-2 mb-2">
                                ...
                                <div class="col-12 col-sm-6 col-lg-2">
                                    ...
                                    <fieldset class="form-group">
                                        <datepicker v-model="filterForm.start_date" name="start_date"
                                            class="form-control" @closed="datepickerClosedFunction"></datepicker>
                                    </fieldset>
                                </div>
                                <div class="col-12 col-sm-6 col-lg-2">
                                ...
                                <div class="col-12 col-sm-6 col-lg-1_5">
                                    <fieldset class="form-group">
                                        ...
                                        <!-- GET NEW REPORT -->
                                        <button type="submit" @click="finter(1)"
                                            class="btn btn-primary mb-2 float-left">Submit</button>

                                        <!-- GET OLD REPORT -->
                                        <button type="submit" @click="getOldReport()"
                                            class="btn btn-primary mb-2 float-right">Old Report</button>
                                    </fieldset>
                                                            ...
                                                            <td>
                                                                <table id="dataTable"
                                                                    ...
                                                                    <thead class="thead-dark">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="4" class="text-center">{{
                                                                                    filterForm.start_date | formatDate
                                                                            }} -
                                                                                {{ filterForm.end_date | formatDate }}
                                                                            </td>
                                                                            <td colspan="4" class="text-center"> {{
                                                                                    filterForm.start_date_previous |
                                                                                    formatDate
                                                                            }}
                                                                                - {{ filterForm.end_date_previous |
                                                                                        formatDate
                                                                                }}
                                                                            </td>
                                                                            <td colspan="1" rowspan="2"> AVG. Production
                                                                                <br>Jan -
                                                                                {{ filterForm.end_date | formatMonth }}
                                                                            </td>
                                                                            <td colspan="1" rowspan="2"> AVG. Delivery
                                                                                <br>Jan -
                                                                                {{ filterForm.end_date | formatMonth }}
                                                                            </td>
                                                                            <td colspan="1" rowspan="2"> Production Plan
                                                                                (as per sales projection)</td>
                                                                            <td colspan="1" rowspan="2"> Factory
                                                                                Capacity</td>
                                                                        </tr>
                                                                        <tr>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr v-for="(item, index ) in deliveris"
                                                                            :key="index">
                                                                            <td>
                                                                            ...
                                                                            <td class="current text-right">{{
                                                                                    formatPrice(item.gnh_production_target)
                                                                            }}</td>
                                                                            <td class="current text-right">{{
                                                                                    formatPrice(item.gnh_actual_production)
                                                                            }}</td>
                                                                            <td class="current text-right">{{
                                                                                    Number(item.gnh_production_target > 0 ?
                                                                                        (item.gnh_actual_production /
                                                                                            item.gnh_production_target) * 100 :
                                                                                        0).toFixed(2)
                                                                            }}%
                                                                            </td>
                                                                            <td class="current text-right">{{
                                                                                    formatPrice(item.gnh_actual_delivery)
                                                                            }}
                                                                            </td>
                                                                            <!-- Previous -->
                                                                            ...
                                                                            <td class="previous text-right">{{
                                                                                    Number(item.gnh_production_target_previous
                                                                                        > 0 ?
                                                                                        (item.gnh_actual_production_previous /
                                                                                            item.gnh_production_target_previous) *
                                                                                        100 : 0).toFixed(2)
                                                                            }}%
                                                                            </td>
                                                                            <td class="previous text-right">{{
                                                                            ...
                                                                            <td class="text-right">{{
                                                                                    formatPrice(item.gnh_actual_production_avg)
                                                                            }}</td>
                                                                            <td class="text-right">{{
                                                                                    formatPrice(item.gnh_actual_delivery_avg)
                                                                            }}</td>
                                                                            <td class="text-right">{{
                                                                            ...
                                                                            <td class="text-right">{{
                                                                                    formatPrice(Number(item.gnh_capacity).toFixed(2))
                                                                            }}</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="14" class="text-center"> OT
                                                                                Hour</td>
                                                                        </tr>
                                                                        <tr v-for="(item, index ) in deliveris"
                                                                            :key="'a' + index">
                                                                            ...
                                                                            <!-- current -->
                                                                            <td class="current text-right">{{
                                                                                    formatPrice(item.oth_production_target)
                                                                            }}</td>
                                                                            <td class="current text-right">{{
                                                                                    formatPrice(item.oth_actual_production)
                                                                            }}</td>
                                                                            <td class="current text-right">{{
                                                                                    Number(item.oth_production_target > 0 ?
                                                                                        (item.oth_actual_production /
                                                                                            item.oth_production_target) * 100 :
                                                                                        0).toFixed(2)
                                                                            }}%
                                                                            </td>
                                                                            ...
                                                                            <td class="previous text-right">{{
                                                                                    Number(item.oth_production_target_previous
                                                                                        > 0 ?
                                                                                        (item.oth_actual_production_previous /
                                                                                            item.oth_production_target_previous) *
                                                                                        100 : 0).toFixed(2)
                                                                            }}%
                                                                            </td>
                                                                            <td class="previous text-right">--</td>
                                                                            <td class="text-right">{{
                                                                                    formatPrice(item.oth_actual_production_avg)
                                                                            }}</td>
                                                                            ...
                                                                            <td class="text-right">{{
                                                                                    formatPrice(Number(item.oth_capacity).toFixed(2))
                                                                            }}</td>
                                                                        </tr>
                                                                    </tbody>
                                                                    <tfoot>
                                                                        <tr v-if="deliveris.length > 0"
                                                                            class="sub_total">
                                                                            <td>Total</td>
                                                                            <!-- current -->
                                                                            <td class="text-right">{{
                                                                                    formatPrice(total_production_target)
                                                                            }}
                                                                            </td>
                                                                            <td class="text-right">{{
                                                                                    formatPrice(total_actual_production)
                                                                            }}
                                                                            </td>
                                                                            <td class="text-right"></td>
                                                                            <td class="text-right">{{
                                                                                    formatPrice(total_actual_delivery)
                                                                            }}
                                                                            </td>
                                                                            <!-- previous -->
                                                                            <td class="text-right">{{
                                                                                    formatPrice(total_production_target_previous)
                                                                            }}</td>
                                                                            <td class="text-right">{{
                                                                                    formatPrice(total_actual_production_previous)
                                                                            }}</td>
                                                                            <td class="text-right"></td>
                                                                            <td class="text-right">{{
                                                                                    formatPrice(total_actual_delivery_previous)
                                                                            }}</td>
                                                                            <td class="text-right">{{
                                                                                    formatPrice(total_actual_production_avg)
                                                                            }}</td>
                                                                            <td class="text-right">{{
                                                                                    formatPrice(total_actual_delivery_avg)
                                                                            }}</td>
                                                                            <td class="text-right">{{
                                                                                    formatPrice(total_production_plan)
                                                                            }}
                                                                            </td>
                                                                            <td class="text-right">{{
                                                                                    formatPrice(total_capacity)
                                                                            }}</td>
                                                                        </tr>
                                                                        <tr v-if="deliveris.length > 0" class="total">
                                                                            ...
                                                                            <td class="text-right">{{
                                                                                    Number(total_capacity ?
                                                                                        (total_production_target /
                                                                                            total_capacity) * 100 : 0).toFixed(2)
                                                                            }}%
                                                                            </td>
                                                                            <td class="text-right">{{
                                                                                    Number(total_capacity ?
                                                                            ...
                                                                            <td class="text-right">{{
                                                                                    Number(total_capacity ?
                                                                                        (total_production_target_previous /
                                                                                            total_capacity) * 100 : 0).toFixed(2)
                                                                            }}%
                                                                            </td>
                                                                            <td class="text-right">{{
                                                                                    Number(total_capacity ?
                                                                                        (total_actual_production_previous /
                                                                                            total_capacity) * 100 : 0).toFixed(2)
                                                                            }}%
                                                                            </td>
                                                                            <td class="text-right"></td>
                                                                            ...
                                                                            <td class="text-right">{{
                                                                                    Number(total_capacity ?
                                                                                        (total_production_plan / total_capacity)
                                                                                        * 100 : 0).toFixed(2)
                                                                            }}%
                                                                            </td>
                                                                            <td class="text-right">{{
                                                                                    Number(total_capacity ? (total_capacity
                                                                                        / total_capacity) * 100 : 0).toFixed(2)
                                                                            }}%
                                                                            </td>
                                                                        </tr>
                                                                        <tr v-if="deliveris.length > 0"
                                                                            ...
                                                                            <td colspan="13" class="text-center">
                                                                                ...
                                                                                <!-- NEW COMMENT -->
                                                                                <button type="button"
                                                                                    class="btn btn-primary add-btn btn-lg d-flex align-items-center text-center"
                                                                                    style="margin-right: 90px;">
                                                                                    <a class="text-white text-center text-bold-900"
                                                                                        style="color: #efefef;"
                                                                                        @click="show_pop('production')">
                                                                                        <i
                                                                                            class="bx bx-add-alt"></i><strong>Remarks</strong></a>
                                                                                </button>
                                                                            </td>
                                                                        </tr>
                                                                    </tfoot>
                                                            ...
                                                            <td>
                                                                <table id="dataTable"
                                                                    ...
                                                                    <tbody class="thead-dark">
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="1" rowspan="3"><b>Raw Material
                                                                                </b></td>
                                                                            <td rowspan="3" colspan="1"><b>UoM</b></td>
                                                                            <td colspan="1" rowspan="3">
                                                                                <b>Standard<br>wastage %</b>
                                                                            </td>
                                                                            <td colspan="9" class="current text-center">
                                                                                {{ filterForm.start_date | formatDate }}
                                                                                -
                                                                                {{ filterForm.end_date | formatDate }}
                                                                            </td>
                                                                            <td colspan="5"
                                                                                class="previous text-center">
                                                                                {{ filterForm.start_date_previous |
                                                                                        formatDate
                                                                                }} -
                                                                                {{ filterForm.end_date_previous |
                                                                            ...
                                                                            <td rowspan="3" colspan="1"><b>Year's
                                                                                    Average <br> (2021)</b></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <!-- current  -->
                                                                            <td colspan="5" class="current text-center">
                                                                                <b>Wastage</b>
                                                                            </td>
                                                                            <td colspan="2" class="current text-center">
                                                                                <b>Consumption</b>
                                                                            </td>
                                                                            <td colspan="1" rowspan="2" class="current">
                                                                                <b>Actual %</b>
                                                                            </td>
                                                                            <td colspan="1" rowspan="2" class="current">
                                                                                <b>Variance %</b>
                                                                            ...
                                                                            <td colspan="1" rowspan="2"
                                                                                class="previous"><b>Actual %</b></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="1" class="current text-center">
                                                                                <b>Standard QTY</b>
                                                                            </td>
                                                                            <td colspan="1" class="current text-center">
                                                                                <b>Actual Qty</b>
                                                                            ...
                                                                            <td colspan="1"
                                                                                class="previous text-center"><b>Qty</b>
                                                                            </td>
                                                                            <td colspan="1"
                                                                                class="previous text-center">
                                                                                <b>Amount</b>
                                                                        ...
                                                                        <tr v-for="(item, index ) in wastage"
                                                                            :key="index">
                                                                            <td>{{ item.group_name }} </td>
                                                                            <td class="text-center">{{ item.uom }}</td>
                                                                            <td class="text-right">{{
                                                                                    Number(item.previous_year_average).toFixed(2)
                                                                            }}%</td>
                                                                            <td class="current text-right">
                                                                                {{ (Number(item.consumtion) *
                                                                                        ((item.previous_year_average) /
                                                                                            100)).toFixed(2)
                                                                                }}
                                                                                <!-- // formatPrice(item.actual_wastage) -->
                                                                            </td>
                                                                            <td class=" text-right">{{
                                                                                    formatPrice(item.actual_wastage)
                                                                            }}</td>
                                                                            ...
                                                                            <td class=" text-right">
                                                                                {{ ((Number(item.consumtion) *
                                                                                        ((item.previous_year_average) /
                                                                                            100)) -
                                                                                        Number(item.actual_wastage).toFixed(0)).toFixed(2)
                                                                                }}</td>
                                                                            <td class=" text-right"> {{
                                                                                    ((((((Number(item.consumtion) *
                                                                                        ((item.previous_year_average) /
                                                                                        ...
                                                                                        (Number(item.consumtion) *
                                                                                            ((item.previous_year_average) /
                                                                                                100)).toFixed(2))) * 100).toFixed(1)
                                                                            }}%</td>
                                                                            <td class=" text-right">
                                                                                {{
                                                                                        (item.consumtion_amount /
                                                                                            (item.consumtion /
                                                                                                ((Number(item.consumtion) *
                                                                                                    ((item.previous_year_average) /
                                                                                                        100)) -
                                                                                                    Number(item.actual_wastage).toFixed(0)).toFixed(2))).toFixed(1)
                                                                                }}
                                                                            </td>


                                                                            <td class="current text-right">{{
                                                                                    formatPrice(item.consumtion)
                                                                            }}</td>
                                                                            <td class=" text-right">{{
                                                                                    formatPrice(item.consumtion_amount)
                                                                            }}
                                                                            </td>
                                                                            <td class="current text-right">{{
                                                                                    Number(item.consumtion ?
                                                                                        (item.actual_wastage / item.consumtion)
                                                                                        * 100 : 0).toFixed(2)
                                                                            }} %
                                                                            </td>
                                                                            <td class="text-right">{{
                                                                            ...
                                                                            <!-- previous -->
                                                                            <td class="previous text-right">{{
                                                                                    formatPrice(item.actual_wastage_previous)
                                                                            }}</td>
                                                                            <td class="previous text-right">{{
                                                                                    formatPrice(item.actual_wastage_amount_previous)
                                                                            }}</td>
                                                                            <td class="previous text-right">{{
                                                                                    formatPrice(item.consumtion_previous)
                                                                            }}
                                                                            </td>
                                                                            <td class="previous text-right">{{
                                                                                    formatPrice(item.consumtion_amount_previous)
                                                                            }}</td>
                                                                            <td class="previous text-right">{{
                                                                                    Number(item.consumtion_previous ?
                                                                                        (item.actual_wastage_previous /
                                                                                            item.consumtion_previous) * 100 :
                                                                                        0).toFixed(2)
                                                                            }} %
                                                                            </td>
                                                                            <td class=" text-right">{{
                                                                                    Number(item.current_year_average).toFixed(2)
                                                                            }}%</td>
                                                                        </tr>
                                                                        <tr v-if="wastage.length > 0"
                                                                            class="text-center">
                                                                            <td colspan="11" class="text-center">
                                                                                ...
                                                                                <button type="button"
                                                                                    class="btn btn-primary add-btn btn-lg d-flex align-items-center text-center"
                                                                                    style="margin-right: 90px;">
                                                                                    <a class="text-white text-white text-bold-900"
                                                                                        style="color: #efefef;"
                                                                                        @click="show_pop('wastage')"> <i
                                                                                            class="bx bx-add-alt"></i><strong>Remarks</strong></a>
                                                                                </button>
                                                            ...
                                                            <td>
                                                                <table id="dataTable"
                                                                    ...
                                                                    <tbody class="thead-dark" v-if="watt5_show == 1">
                                                                        <tr>
                                                                            <td colspan="1" rowspan="3"><b>Raw
                                                                                    Material</b></td>
                                                                            <td rowspan="3" colspan="1"><b>UoM</b></td>
                                                                            <td colspan="1" rowspan="3">
                                                                                <b>Standard<br>wastage %</b>
                                                                            </td>
                                                                            <td colspan="6" class="current text-center">
                                                                                {{ filterForm.start_date | formatDate }}
                                                                                -
                                                                                {{ filterForm.end_date | formatDate }}
                                                                            </td>
                                                                        ...
                                                                        <tr v-for="(item, index ) in watt5"
                                                                            ...
                                                                            <td class="current text-right">{{
                                                                                    formatPrice(item.actual_wastage_amount)
                                                                            }}</td>
                                                                            <td class="current text-right">{{
                                                                                    formatPrice(item.consumtion)
                                                                            }}</td>
                                                                        ...
                                                                        <tr v-if="wastage.length > 0 && watt5_show == 1"
                                                                            class="text-center">
                                                                            <td colspan="11" class="text-center">
                                                            ...
                                                            <td>
                                                                <table id="dataTable"
                                                                    ...
                                                                    <tbody class="thead-dark">
                                                                        ...
                                                                        <tr>
                                                                            <td rowspan="2" class="text-center"><b>
                                                                                    EXPENSE HEAD</b></td>
                                                                            <td colspan="2" class="text-current">{{
                                                                                    filterForm.start_date | formatDate
                                                                            }} -
                                                                                {{ filterForm.end_date | formatDate }}
                                                                            </td>
                                                                            ...
                                                                            <td colspan="2" class="text-center"> AVG.
                                                                                <br>Jan -
                                                                                {{ filterForm.end_date | formatMonth }}
                                                                            </td>
                                                                            <td rowspan="2" class="text-center">
                                                                                <b>AMOUNT</b><br>(Standard)
                                                                            </td>
                                                                            <td rowspan="2" class="text-right">
                                                                                <b>PER&nbsp;UNIT </b><br>(Standard)
                                                                            </td>
                                                                            <td rowspan="2" class="text-right">
                                                                                <b>Status</b>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td title="CURRENT MONTH"
                                                                                class="text-center"><b>AMOUNT[BDT]</b>
                                                                            </td>
                                                                            <td class="text-center"><b>PER UNIT</b>
                                                                            </td>
                                                                            <td class="previous text-center"
                                                                                title="PREVIOUS MONTH">
                                                                                <b>AMOUNT[BDT]</b>
                                                                            </td>
                                                                            <td class="previous text-center"
                                                                                title="PREVIOUS MONTH"><b>PER UNIT</b>
                                                                            </td>

                                                                            <td class="text-center"><b>AVERAGE COST</b>
                                                                            </td>
                                                                            <td class="text-center"><b>AVERAGE PER
                                                                                    UNIT</b>
                                                                            </td>
                                                                        ...
                                                                        <tr v-for="(item, index ) in cost_center_gnh"
                                                                            :key="'cost_gng' + index">
                                                                            <td>{{ item.gl_name }}</td>
                                                                            <td class="text-right">{{
                                                                            ...
                                                                            <td class="text-right">{{
                                                                                    (total_actual_production_gnh ? item.cost
                                                                                        / total_actual_production_gnh :
                                                                                        0).toFixed(2)
                                                                            }}
                                                                            </td>
                                                                            <td class="previous text-right">{{
                                                                                    formatPrice(item.cost_previous)
                                                                            }}</td>
                                                                            <td class="previous text-right">{{
                                                                                    (total_actual_production_gnh_previous ?
                                                                                        item.cost_previous /
                                                                                        total_actual_production_gnh_previous :
                                                                                        0).toFixed(2)
                                                                            }}
                                                                            ...
                                                                            <td class="text-right"> {{
                                                                                    formatPrice(item.average_cost ?
                                                                                        item.average_cost : 0)
                                                                            }}
                                                                            </td>
                                                                            <td class="text-right">{{
                                                                                    Number(total_gnh_actual_production_avg ?
                                                                                        item.average_cost /
                                                                                        total_gnh_actual_production_avg :
                                                                                        0).toFixed(2)
                                                                            }}
                                                                            </td>
                                                                            <td class="text-right">{{
                                                                                    formatPrice(item.standard_gnh)
                                                                            }}</td>
                                                                            <td class="text-right"> {{
                                                                                    Number(total_production_plan_gnh ?
                                                                                        item.standard_gnh /
                                                                                        total_production_plan_gnh :
                                                                                        0).toFixed(2)
                                                                            }}
                                                                            </td>
                                                                            <td class="text-right"
                                                                            ...
                                                                            <td class="text-right"
                                                                                ...
                                                                                Up.[{{
                                                                                        Number((total_actual_production_gnh ?
                                                                                            item.cost / total_actual_production_gnh
                                                                                            : 0) - (total_production_plan_gnh ?
                                                                                                item.standard_gnh /
                                                                                                total_production_plan_gnh :
                                                                                                0)).toFixed(2)
                                                                                }}]TK
                                                                        ...
                                                                        <tr class="sub_total summary_text_tr">
                                                                            ...
                                                                            <td class="previous text-right">{{
                                                                                    formatPrice(total_gnh_cost_previous)
                                                                            }}
                                                                            </td>
                                                                            <td class="previous text-right">{{
                                                                            ...
                                                                            <td class="text-right">{{
                                                                                    formatPrice(total_gnh_average_cost)
                                                                            }}
                                                                            </td>
                                                                            <td class="text-right">
                                                                                {{
                                                                                        Number(total_gnh_actual_production_avg ?
                                                                                            (total_gnh_average_cost /
                                                                                                total_gnh_actual_production_avg) :
                                                                                            0).toFixed(2)
                                                                                }}
                                                                            </td>
                                                                            <td class="text-right">{{
                                                                                    formatPrice(total_standard_gnh)
                                                                            }}</td>
                                                                            <td class="text-right">{{
                                                                                    (total_production_plan_gnh ?
                                                                                        total_standard_gnh /
                                                                            ...
                                                                            <td class="text-right summary_text"
                                                                                ...
                                                                                bgcolor="#3BC82A85" align="right"> Cost
                                                                                Down.[{{
                                                                                        Number((total_production_plan_gnh ?
                                                                                            total_standard_gnh /
                                                                                            total_production_plan_gnh : 0) -
                                                                                            gnh_total_per_unit(total_actual_production_gnh)).toFixed(2)
                                                                                }}]TK
                                                                            </td>
                                                                            <td class="text-right summary_text"
                                                                                v-if="((total_production_plan_gnh ? total_standard_gnh / total_production_plan_gnh : 0) - gnh_total_per_unit(total_actual_production_gnh)) == 0"
                                                                            ...
                                                                            <td class="text-right summary_text"
                                                                                v-if="((total_production_plan_gnh ? total_standard_gnh / total_production_plan_gnh : 0) - gnh_total_per_unit(total_actual_production_gnh)) < 0"
                                                                                bgcolor="#FF1818" align="right"> Cost
                                                                                Up.[{{
                                                                                        Number(gnh_total_per_unit(total_actual_production_gnh)
                                                                                            - (total_production_plan_gnh ?
                                                                                                total_standard_gnh /
                                                                                                total_production_plan_gnh :
                                                                                                0)).toFixed(2)
                                                                        ...
                                                                        <tr v-for="(item, index ) in cost_center_oth"
                                                                            :key="'cost_oth' + index">
                                                                            ...
                                                                            <td class="text-right">{{
                                                                                    (total_actual_production_oth ? item.cost
                                                                                        / total_actual_production_oth :
                                                                                        0).toFixed(2)
                                                                            }}
                                                                            </td>
                                                                            <td class="previous text-right">{{
                                                                            ...
                                                                            <td class="previous text-right">{{
                                                                                    Number(total_actual_production_oth_previous
                                                                                        ? item.cost_previous /
                                                                                        total_actual_production_oth_previous :
                                                                                        0).toFixed(2)
                                                                            }}
                                                                            </td>
                                                                            <td class="text-right">{{
                                                                            ...
                                                                            <td class="text-right">{{
                                                                                    Number(total_oth_actual_production_avg ?
                                                                                        item.average_cost /
                                                                                        total_oth_actual_production_avg :
                                                                                        0).toFixed(2)
                                                                            }}
                                                                            </td>
                                                                            <td class="text-right">{{
                                                                                    formatPrice(item.standard_oth ?
                                                                                        item.standard_oth : 0)
                                                                            }}
                                                                            </td>
                                                                            <td class="text-right"> {{
                                                                                    Number(total_production_plan_oth ?
                                                                                        item.standard_oth /
                                                                                        total_production_plan_oth :
                                                                                        0).toFixed(2)
                                                                            }}
                                                                            </td>
                                                                            ...
                                                                            <td class="text-right"
                                                                                ...
                                                                                bgcolor="#ffd6d6" align="right"> Cost
                                                                                Up.[{{
                                                                                        Number((total_actual_production_oth ?
                                                                                            item.cost / total_actual_production_oth
                                                                                            : 0) - (total_production_plan_oth ?
                                                                                                item.standard_oth /
                                                                                                total_production_plan_oth :
                                                                                                0)).toFixed(2)
                                                                                }}]TK
                                                                        ...
                                                                        <tr class="sub_total summary_text_tr">
                                                                            ...
                                                                            <td class="previous text-right">{{
                                                                                    formatPrice(total_oth_cost_previous)
                                                                            }}
                                                                            </td>
                                                                            <td class="previous text-right">{{
                                                                            ...
                                                                            <td class="text-right">{{
                                                                                    formatPrice(total_oth_average_cost)
                                                                            }}
                                                                            </td>
                                                                            <td class="text-right">
                                                                                {{
                                                                                        Number(total_oth_actual_production_avg ?
                                                                                            (total_oth_average_cost /
                                                                                                total_oth_actual_production_avg) :
                                                                                            0).toFixed(2)
                                                                                }}
                                                                            </td>
                                                                            <td class="text-right"> {{
                                                                                    formatPrice(total_standard_oth)
                                                                            }}</td>
                                                                            <td class="text-right">{{
                                                                                    (total_production_plan_oth ?
                                                                                        total_standard_oth /
                                                                            ...
                                                                            <td class="text-right summary_text"
                                                                                ...
                                                                                Down.[{{
                                                                                        Number((total_production_plan_oth ?
                                                                                            total_standard_oth /
                                                                                            total_production_plan_oth : 0) -
                                                                                            oth_total_per_unit(total_actual_production_oth)).toFixed(2)
                                                                                }}]TK
                                                                            </td>
                                                                            <td class="text-right summary_text"
                                                                                v-if="((total_production_plan_oth ? total_standard_oth / total_production_plan_oth : 0) - oth_total_per_unit(total_actual_production_oth)) == 0"
                                                                            ...
                                                                            <td class="text-right summary_text"
                                                                                ...
                                                                                bgcolor="#FF1818" align="right"> Cost
                                                                                Up.[{{
                                                                                        Number(oth_total_per_unit(total_actual_production_oth)
                                                                                            - (total_production_plan_oth ?
                                                                                                total_standard_oth /
                                                                                                total_production_plan_oth :
                                                                                                0)).toFixed(2)
                                                                            ...
                                                                            <!-- <td class="text-right summary_text"   v-if="((total_production_plan_oth ?  total_standard_oth / total_production_plan_oth : 0) - gnh_total_per_unit(total_actual_production_oth)) > 0"   bgcolor="#3BC82A85" align="right"> Cost Down.[{{Number((total_production_plan_oth ?  total_standard_oth / total_production_plan_oth : 0) - oth_total_per_unit(total_actual_production_oth)).toFixed(2) }}]TK </td>
                                    <td class="text-right summary_text"   v-if="((total_production_plan_oth ?  total_standard_oth / total_production_plan_oth : 0) - gnh_total_per_unit(total_actual_production_oth)) == 0"   bgcolor="#3BC82A85" align="right"> 00  </td>
                                    <td class="text-right summary_text"   v-if="((total_production_plan_oth ?  total_standard_oth / total_production_plan_oth : 0) - gnh_total_per_unit(total_actual_production_oth)) < 0"   bgcolor="#FF1818" align="right"> Cost Up.[{{Number((total_production_plan_oth ?  total_standard_oth / total_production_plan_oth : 0) - oth_total_per_unit(total_actual_production_oth)).toFixed(2) }}]TK </td>  -->
                                                                        ...
                                                                        <tr class="total summary_text_tr">
                                                                            ...
                                                                            <td class="text-right">
                                                                                {{ Number((total_gnh_cost +
                                                                                        total_oth_cost) /
                                                                                        total_actual_production).toFixed(2)
                                                                                }}
                                                                            </td>
                                                                            <td class="previous text-right ">
                                                                                {{ formatPrice(total_gnh_cost_previous +
                                                                                        total_oth_cost_previous)
                                                                                }}
                                                                            </td>
                                                                            <td class="previous text-right">{{
                                                                                    Number((total_gnh_cost_previous +
                                                                                        total_oth_cost_previous) /
                                                                                        total_actual_production_previous).toFixed(2)
                                                                            }}
                                                                            </td>
                                                                            <td class="text-right">
                                                                                {{ formatPrice(total_gnh_average_cost +
                                                                            ...
                                                                            <td class="text-right">
                                                                                {{
                                                                                        Number(total_actual_production_avg ?
                                                                                            ((total_gnh_average_cost +
                                                                                                total_oth_average_cost) /
                                                                                                total_actual_production_avg) :
                                                                                            0).toFixed(2)
                                                                            ...
                                                                            <td class="text-right summary_text"
                                                                                ...
                                                                                bgcolor="#3BC82A85" align="right"> Cost
                                                                                Down.[{{
                                                                                        Number((total_standard_gnh +
                                                                                            total_standard_oth) /
                                                                                            (total_production_plan_gnh +
                                                                                                total_production_plan_oth) -
                                                                                            ((total_gnh_cost + total_oth_cost) /
                                                                                                total_actual_production)).toFixed(2)
                                                                                }}]TK
                                                                            </td>
                                                                            <td class="text-right summary_text"
                                                                                ...
                                                                                Up.[{{
                                                                                        Number(((total_gnh_cost +
                                                                                            ...
                                                                                            (total_standard_gnh +
                                                                                                total_standard_oth) /
                                                                                            (total_production_plan_gnh +
                                                                                                total_production_plan_oth)).toFixed(2)
                                                                                }}]TK
                                                                            </td>
                                ...
                                <section id="dashboard-analytics">
                                    <nav>
                                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                            <a @click="tabs('list')" aria-controls="nav-home" aria-selected="true"
                                                class="nav-item nav-link" data-toggle="tab" href="#nav-home"
                                                id="nav-home-tab" role="tab"
                                                v-bind:class="{ active: comment_active == 'list' }">
                                                Remark list
                                            </a>
                                            <a @click="tabs('add')" aria-controls="nav-home" aria-selected="true"
                                                class="nav-item nav-link" data-toggle="tab" href="#nav-home"
                                                id="nav-home-tab" role="tab"
                                        ...
                                        <tbody v-if="comment_active == 'add'">
                                            <tr>
                                                <th colspan="2" class="text-center">
                                                    <div class="form-group has-success">
                                                        ...
                                                        <select v-if="feedbackType == 'production'" name="production"
                                                            id="production"
                                                        ...
                                                        <select v-if="feedbackType == 'wastage'" name="production"
                                                            id="production"
                                                            v-model="production_feadback_mailForm.production_type"
                                                            class="form-control chzn-select">
                                                            <option value="">SELECT</option>
                                                ...
                                                <th colspan="2" class="text-center">
                                                    <div class="form-group has-success">
                                                        ...
                                                        <select v-if="feedbackType == 'production'" name="section"
                                                            id="section"
                                                            v-model="production_feadback_mailForm.section_name"
                                                            class="form-control chzn-select">
                                                            <option value="">SELECT</option>
                                                        ...
                                                        <select v-if="feedbackType == 'wastage'" name="production"
                                                            ...
                                                            class="form-control chzn-select">
                                                            <option value="">SELECT</option>
                                                            <option v-for="row in itemsSummaryGroup"
                                                                :key="row.description" :value="row.id">
                                                                {{ row.description }}
                                                            </option>
                                                        </select>
                                                    </div>
                                            ...
                                            <tr>
                                                <th colspan="4" class="text-center">
                                                    <vue-editor v-model="production_feadback_mailForm.comments"
                                                        name="task" placeholder="Remark...."></vue-editor>
                                                </th>
                                            </tr>
                                            ...
                                            <tr>
                                                <th class="text-center">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input v-model="production_feadback_mailForm.mailcc1"
                                                                placeholder="example1@gmail.com" class="form-control"
                                                                type="text" />
                                                        </div>
                                                    </div>
                                                </th>
                                                <th class="text-center">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input v-model="production_feadback_mailForm.mailcc2"
                                                                placeholder="example2@gmail.com" class="form-control"
                                                                type="text" />
                                                        </div>
                                                    </div>
                                                ...
                                                <th class="text-center">
                                                    <div class="form-group">
                                                        <label for="Profession">Mail CC3</label>
                                                        <div class="controls">
                                                            <input v-model="production_feadback_mailForm.mailcc3"
                                                                placeholder="example3@gmail.com" class="form-control"
                                                                type="text" />
                                                        </div>
                                                    </div>
