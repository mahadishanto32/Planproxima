                        ...
                        <div class="col-sm-9">
                            <div class="breadcrumb-wrapper col-9">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">Wastage
                                    </li>
                                </ol>
                            </div>
                        </div>
                                            ...
                                            <table class="table table-striped"> 
                                                    ...
                                                    <tbody>
                                                      <tr  v-for="(item , index ) in items" :key="item.id" > 
                                                        ...
                                                        <td> {{ item.costjoin ? item.costjoin.cost_code : '--'  }}</td>
                                                        ...
                                                        <td> {{ item.date}}</td> 
                                                        <td> {{ item.actual_wastage}}</td> 
                                                        <td> {{ item.wastage_value}}</td> 
                                                        <td> {{ item.remarks}}</td>  
                                                      </tr> 
                                                    </tbody>
                                                  </table>
...
export default {
    ...
    methods: { 
        async getItems() {
            ...
            try {
                await axios
                    .get(this.api_url + "wastage" + where, {
                        headers: {
