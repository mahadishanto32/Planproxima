                          ...
                          <tr>
                            <td>
                              <table id="dataTable"
                                ...
                                <tr>
                                  <th class="text-center" colspan="15" style="font-size: 18px;">
                                    Wastage Report
                                  </th>
                                </tr>
                                <tr>
                                  <td colspan="1" rowspan="3"><b>Raw Material </b></td>
                                  <td rowspan="3" colspan="1"><b>UoM</b></td>
                                  <td colspan="1" rowspan="3"><b>Standard<br>wastage %</b></td>
                                  <td colspan="6" class="current text-center">{{ filterForm.start_date | formatDate }} -
                                    {{ filterForm.end_date | formatDate }}
                                  </td>
                                  <td colspan="5" class="previous text-center">
                                    {{ filterForm.start_date_previous | formatDate }} -
                                    {{ filterForm.end_date_previous | formatDate }}
                                  </td>
                                  <td rowspan="3" colspan="1"><b>Year's Average <br> (2021)</b></td>
                                </tr>
                                <tr>
                                  <!-- current  -->
                                  <td colspan="2" class="current text-center"><b>Wastage</b></td>
                                  <td colspan="2" class="current text-center"><b>Consumption</b></td>
                                  <td colspan="1" rowspan="2" class="current"><b>Actual %</b></td>
                                  <td colspan="1" rowspan="2" class="current"><b>Variance %</b></td>
                                  <!-- previous  -->
                                  <td colspan="2" class="previous text-center"><b>Wastage</b></td>
                                  <td colspan="2" class="previous text-center"><b>Consumption</b></td>
                                  <td colspan="1" rowspan="2" class="previous"><b>Actual %</b></td>
                                </tr>
                                <tr>
                                  <td colspan="1" class="current text-center"><b>Qty</b></td>
                                  <td colspan="1" class="current text-center"><b>Amount</b></td>  
                                  <td colspan="1" class="current text-center"><b>Qty</b></td>
                                  <td colspan="1" class="current text-center"><b>Amount</b></td>  

                                  <td colspan="1" class="previous text-center"><b>Qty</b></td>
                                  <td colspan="1" class="previous text-center"><b>Amount</b></td>  
                                  <td colspan="1" class="previous text-center"><b>Qty</b></td>
                                  <td colspan="1" class="previous text-center"><b>Amount</b></td>
                                </tr>
                                <tr v-for="(item , index ) in wastage" :key="index">
                                  ...
                                  <td class=" text-right">{{ formatPrice(item.actual_wastage_amount) }}</td>
                                  <td class="current text-right">{{ formatPrice(item.consumtion) }}</td>
                                  <td class=" text-right">{{ formatPrice(item.consumtion_amount) }}</td>
                                  <td class="current text-right">{{
                                  ...
                                  <td class="previous text-right">{{ formatPrice(item.actual_wastage_amount_previous) }}</td>
                                  <td class="previous text-right">{{ formatPrice(item.consumtion_previous) }}</td>
                                  <td class="previous text-right">{{ formatPrice(item.consumtion_amount_previous) }}</td>
                                  <td class="previous text-right">{{
                          ...
                          <tr v-if="filterForm.summary_group_id == 3">
                            <td>
                              <table id="dataTable"
                                ...
                                <tr>
                                  <!-- current  -->
                                  <td colspan="2" class="current"><b>Wastage</b></td>
                                  <td colspan="2" class="current"><b>Consumption</b></td>
                                  <td colspan="1" rowspan="2" class="current"><b>Actual %</b></td>
                                  <td colspan="1" rowspan="2" class="current"><b>Variance %</b></td>
                                  <!-- previous  -->
                                  <td colspan="2" class="previous"><b>Wastage</b></td>
                                  <td colspan="2" class="previous"><b>Consumption</b></td>
                                  <td colspan="1" rowspan="2" class="previous"><b>Actual %</b></td>
                                </tr>
                                <tr>
                                  <td colspan="1" class="current text-center"><b>Qty</b></td>
                                ...
                                <tr v-for="(item , index ) in watt5" :key="index">
                                  ...
                                  <td class="text-right">{{ Number(item.previous_year_average).toFixed(2) }}%</td>
                                  <td class="current text-right">{{ formatPrice(item.actual_wastage) }}</td>
                                  <td class="current text-right">{{ formatPrice(item.actual_wastage_amount) }}</td>
                                  <td class="current text-right">{{ formatPrice(item.consumtion) }}</td>
                                  <td class="current text-right">{{ formatPrice(item.consumtion_amount) }}</td>
                                  <td class="current text-right">{{
                                      Number(item.consumtion ? (item.actual_wastage / item.consumtion) * 100 : 0).toFixed(2)
                                    }} %
                                  </td>
                            ...
                            <td>
                              <table id="dataTable"
                                ...
                                <tr>
                                  ...
                                  <td class="text-center"><b>AVERAGE PER UNIT</b>
                                  </td>
