                            ...
                            <div class="breadcrumb-wrapper col-9">
                                <ol class="breadcrumb p-0 mb-0">
                                   <li class="breadcrumb-item"><router-link :to="{ path: '/' }"><i class="bx bx-home-alt"></i></router-link>
                                    ...
                                    <li class="breadcrumb-item active"> KRA, KPI Share
                                    </li>
...
export default {
  ...
  methods: {
    ...
    async getItems(){
        //departments_all
        let loader = this.$loading.show();
        await axios.get(this.api_url + "share_kra_kpi/"+this.user_id, {
                headers: {
                "Content-Type": "application/json", 
                Authorization: this.token ? `Bearer ${this.token}` : ""
                },
      ...
      create(){ 
                try {
                    ...
                    this.dept_permission.post(this.api_url + "share_kra_kpi_permission", {
                        headers: {
                        "Content-Type": "application/json", 
                        Authorization: this.token ? `Bearer ${this.token}` : ""
                        },
