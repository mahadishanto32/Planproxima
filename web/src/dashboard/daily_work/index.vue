              ...
              <div class="row ">
                ...
                >
                  ...
                  <fieldset class="form-group">
                    ...
                    <Select2  v-model="filterForm.dept_id"
                    v-on:change="getWing()"  placeholder="Select One" :options="deptItems"  />
                      ...
                      >
                        ...
                        <button
                          ...
                          class="
                            ...
                            align-items-center
                          "
                          v-if="role_id == 5 && deptItems[0].is_factory == 1 && deptItems.length == 1"
                        >
                          <router-link
                        ...
                        <button type="button" class="  btn btn-primary add-btn btn-lg  d-flex align-items-center " > 
                          <router-link :to="{ path: '/daily_work_calendar' }" class="text-white" style="margin-left: 10px ;" > <i class="bx bx-add-alt"> </i> Work Schedule (Calendar View) </router-link>
                        </button>
                        ...
                        >
                          <thead class="thead-dark">
                            <tr>
                              ...
                              <th v-if="searchValueTaypeVisible(0)" style="width: 25%">Things to Do</th>
                              <template v-for="(schedule ,index) in scheduleTypes" >
                                <th style="width: 25%" :key="index" v-if="searchValueTaypeVisible(schedule.id)" >
                                  {{schedule.name}}
                                </th>
                              </template>
                          ...
                          <tbody>
                            ...
                            <template v-for="(item, index) in items">
                              ...
                              >
                                <td>
                                  ...
                                  <span class="date_time_start_end">{{ formatAMPM(item.start_time) }} to {{ formatAMPM(item.end_time) }} </span>
                                </td> 
                                <td
                                  v-if="
                                    role_id == 1 ||
                                ...
                                <td v-if="searchValueTaypeVisible(0)" > 
                                  <p
                                ...
                                <template  v-for="(schedule ,index) in scheduleTypes">
                                  <td :key="index" v-if="searchValueTaypeVisible(schedule.id)" >
                                    <div v-if="item.schedule_items.length > 0 ">
                                      <div v-for="(row, index) in item.schedule_items" :key="index">
                                        <div v-if="searchValueTaypeVisible(row.schedule_type_id) && (row.schedule_type_id == schedule.id) "  > 
                            ...
                            <template v-for="(item, index) in items">
                              ...
                              >
                                ...
                                <td v-for="(schedule ,index) in scheduleTypes" :key="index" ></td>
                                <td
                                  v-if="
                                    filterForm.show_kra == 1 &&
                                    (role_id == 5 ||
